...
function startServer(port = 3984) {
...
(async () => {
  ...
  await page.evaluate(() => {
    ...
    // hide tweaks panel and playback bar
    ...
    // hide tweaks panel (sibling of Stage inside the React.Fragment)
  ...
  const outputPath = path.join(__dirname, 'six_things_teaser_v5.mp4');
  execSync(
